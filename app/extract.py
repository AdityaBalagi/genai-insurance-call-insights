...
vertexai.init(project="gcp-deployment-example-312025", location="us-central1")

def extract_insurance_insights(gcs_uri: str):
...
"""
    ...
    content = [
        prompt,
        Part.from_uri(gcs_uri, mime_type="audio/mp3")
    ]
    ...
    try:
        ...
        result["call_id"] = gcs_uri.split("/")[-1]
